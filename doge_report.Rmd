...
### FastQC
```{r}
#htmltools::includeHTML("./10.MULTIQC/1.Report_FastQC_Raw.html")
tags$iframe(
    title = "My embedded document", 
    src = "./10.MULTIQC/1.Report_FastQC_Raw.html",
    width="100%", 
    height="400",
    seamless="seamless", 
    frameBorder="0")
...
htmltools::tags$iframe(
    title = "My embedded document", 
    src = "./10.MULTIQC/2.Report_Trimming.html",
    width="100%", 
    height="400",
    seamless="seamless", 
    frameBorder="0")
...
htmltools::tags$iframe(
    title = "My embedded document", 
    src = "./10.MULTIQC/3.Report_FastQC_Trimmed.html",
    width="100%", 
    height="400",
    seamless="seamless", 
    frameBorder="0")
...
htmltools::tags$iframe(
    title = "My embedded document", 
    src = "./10.MULTIQC/4.Report_Alignment.html",
    width="100%", 
    height="400",
    seamless="seamless", 
    frameBorder="0")
