...
tags$iframe(
    title = "FastQC report",
    src = paste0(baseWD,"7.RMD/Report_FastQC_Raw.html"),
    width="100%",
    height="500",
    seamless="seamless",
    frameBorder="0")
...
htmltools::tags$iframe(
    ...
    src = paste0(baseWD,"7.RMD/Report_Trimming.html"),
    width="100%",
    height="500",
    seamless="seamless",
    frameBorder="0")
...
htmltools::tags$iframe(
    ...
    src = paste0(baseWD,"7.RMD/Report_FastQC_Trimmed.html"),
    width="100%",
    height="500",
    seamless="seamless",
    frameBorder="0")
...
htmltools::tags$iframe(
    ...
    src = paste0(baseWD,"7.RMD/Report_Alignment.html"),
    width="100%",
    height="500",
    seamless="seamless",
    frameBorder="0")
...
First we read in counts data inside the `6.COUNTS/counts.matrix` file, the experimental design (`7.RMD/exp_design.csv`), and the gene annotation table (`7.RMD/gene_annotation.txt`).
```{r, cache=TRUE}
exp_design <- read.table(paste0(baseWD,"7.RMD/exp_design.csv"), header=T, sep=",")
countData <- read.table(paste0(baseWD,"6.COUNTS/counts.matrix"), header=T, sep="\t", row.names=1)

# get rid of rows with zero values
countData <- countData[apply(countData, 1, function(countData) !all(countData==0)),]

# Load annotation table
dbs <- read.table(paste0(baseWD,"7.RMD/gene_annotation.txt"), header=FALSE, sep="\t")
